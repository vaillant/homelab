# NixOS VMs
# Define VMs in terraform.tfvars using the nixos_vms variable
...
# LXC containers
# Define containers in terraform.tfvars using the lxc_containers variable
...
module "lxc_containers" {
  ...
  # Features
  features_nesting = lookup(each.value, "features_nesting", false)
